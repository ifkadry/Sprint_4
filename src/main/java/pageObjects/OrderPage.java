...
public class OrderPage {
    ...
    // Обертка для списка доступных станций метро
    ...
    // Обертка для выпадающего списка продолжнительности аренды
    private final By termDropdownRoot = By.className("Dropdown-root");

    // Список доступных для выбора суток аренды
    ...
    // Текст об успешном оформлении заказа в всплывающем окне
    ...
    // Метод для ракрытия списка продолжительности аренды
