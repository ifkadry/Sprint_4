...
public class OrderPageTests {
    ...
    public static Object[][] setDataForOrder() {
        return new Object[][] {
            {"Петр", "Колотушкин", "ул. Авиамоторная, д. 5, кв. 6", "Авиамоторная", "89152455566", "01.08.2024", "четверо суток", "чёрный жемчуг", "Поторопитесь!"},
            {"Ольга ", "Бочкина", "ул. Пупкина, д. 7, кв. 8", "Динамо", "+79161393909", "31.07.2024", "трое суток", "серая безысходность", "Позвонить заранее"},
        };
    }
    ...
    public void startUp() {
        ...
        this.webDriver = new ChromeDriver();    // падает на подтверждении оформления заказа
        webDriver = new FirefoxDriver();       // успешно
